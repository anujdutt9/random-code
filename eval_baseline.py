...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_tokenized_version", default=False,
                        action=BooleanOptionalAction)  # TODO: Add this through the parsers
    parser.add_argument("--encoding_method", type=str, default="qa",
                        choices=["qa", "instruct"])  # TODO: Add this through the parsers
